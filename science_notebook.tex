...
\makeatother
    ...
    \hypertarget{newtons-second-law-of-motion}{%
...
\end{tcolorbox}
    ...
    \hypertarget{height-of-an-object}{%
...
\end{Verbatim}
    ...
    \hypertarget{integral-calculation}{%
...
\end{Verbatim}
    ...
    \hypertarget{time-to-reach-height-of-y_c}{%
...
\end{Verbatim}
    ...
    \hypertarget{the-hyperbolic-sine-function-sinhx-frac12ex---e-x-and-other-math-functions-with-right-hand-sides.}{%
...
\prompt{Out}{outcolor}{84}{}
    ...
    \hypertarget{taylor-series-polynomial-to-approximate-functions}{%
...
\end{Verbatim}
    ...
    \hypertarget{trajectory-of-an-object}{%
...
\end{Verbatim}
    ...
    \hypertarget{conversion-from-meters-to-british-units}{%
...
\end{Verbatim}
    ...
    \hypertarget{print-table-using-an-approximate-fahrenheit-celcius-conversiion.}{%
...
\end{Verbatim}
    ...
    \hypertarget{create-sequences-of-odds-from-1-to-any-number.}{%
...
\end{Verbatim}
    ...
    \hypertarget{compute-energy-levels-in-an-atom}{%
...
\PY{c+c1}{\PYZsh{} convert to python function}
\PY{n}{y} \PY{o}{=} \PY{n}{lambdify}\PY{p}{(}\PY{p}{[}\PY{n}{m\PYZus{}e}\PY{p}{,} \PY{n}{e}\PY{p}{,} \PY{n}{epsilon\PYZus{}0}\PY{p}{,} \PY{n}{h}\PY{p}{,} \PY{n}{n}\PY{p}{]}\PY{p}{,}  \PY{c+c1}{\PYZsh{} arguments in En}
...
\PY{k}{def} \PY{n+nf}{compute\PYZus{}atomic\PYZus{}energy}\PY{p}{(}\PY{n}{m\PYZus{}e}\PY{o}{=}\PY{l+m+mf}{9.094E\PYZhy{}34}\PY{p}{,} 
    ...
    \PY{k}{for} \PY{n}{n} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{20}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} Compute for 1,...,20}
        \PY{n}{En} \PY{o}{+}\PY{o}{=} \PY{n}{y}\PY{p}{(}\PY{n}{m\PYZus{}e}\PY{p}{,} \PY{n}{e}\PY{p}{,} \PY{n}{epsilon\PYZus{}0}\PY{p}{,} \PY{n}{h}\PY{p}{,} \PY{n}{n}\PY{p}{)}
